...
public class DataAdapter {
    ...
    public int create_person(Map<String, Object> person_info) {
    	int person_id = -1;
    	if (person_info.containsKey("name") && person_info.containsKey("gender") && person_info.containsKey("age") && person_info.containsKey("tel")) {
    		...
    		Cursor cursor = this.db.rawQuery("SELECT _id FROM person WHERE rowid=?;", new String[]{String.valueOf(rowid)});
    ...
    public int create_person_record(Map<String, Object> record) {
    	if (record.containsKey("name") &&  
    			record.containsKey("gender") && 
    			record.containsKey("age") &&
    			record.containsKey("tel") &&
    			record.containsKey("type") &&
    			record.containsKey("sound_file") ) {
	...
	public List<Map<String, Object>> get_medical_records() {
		...
		Cursor cursor = this.db.rawQuery("SELECT _id,name,gender,age,tel FROM person ORDER BY name;", new String[]{});
